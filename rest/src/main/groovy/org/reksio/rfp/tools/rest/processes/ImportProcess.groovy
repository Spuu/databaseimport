...
//        }
    ...
    private static List<Cpty> prepareCpties() {
        ...
        cpties << new Cpty('24', 'Sum-Plast')
        cpties << new Cpty('26', 'Zooleszcz')
        cpties << new Cpty('27', 'Champion')
